...
//        byte[] data = new byte[]{12, 22, 23, 41, 45, 23, 34, 43, 65, 90, 20, 127, 1, 21, 119, 120, 23, 55, 80, 71};
//        print(data);
//        String mime = Base64Coder.encodeLines(data);
//        System.out.print(mime);
//        byte[] copy = Base64Coder.decodeLines(mime);
//        print(copy);
